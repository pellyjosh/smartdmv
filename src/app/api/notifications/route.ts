...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await NotificationService.createNotification({
      userId: userId || user.id, // Use requesting user ID if no specific userId provided
    ...
    console.log('✅ Notification created successfully with ID:', result.notificationId);
