...
export default function AddonDetailsPage() {
  ...
  const { data: addon, isLoading: addonLoading, error } = useQuery<Addon>({
  ...
  const isSubscribed = practiceAddons?.some(
    (subscription: any) => 
  ...
  const subscribeMutation = useMutation({
    mutationFn: async () => {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.error || 'Failed to subscribe to add-on');
      }
    ...
    onSuccess: () => {
      toast({
        ...
        description: `You've successfully subscribed to ${addon?.name}!`,
      });
      queryClient.invalidateQueries({ queryKey: ["/api/marketplace/practice"] });
  ...
  const cancelMutation = useMutation({
    mutationFn: async () => {
      ...
      const response = await fetch(`/api/marketplace/practice/${userPracticeId}/cancel`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const features = Array.isArray(addon.features) ? addon.features : JSON.parse(addon.features || '[]');
      ...
      <div className="mb-6">
        ...
        <div className="flex items-start gap-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-muted-foreground text-lg mb-4">{addon.shortDescription}</p>
              ...
              {isSubscribed ? (
                <div className="space-y-4">
                  <div className="text-center py-4">
                    ...
                    <h3 className="font-semibold text-green-700">Already Subscribed</h3>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground mb-4">
                Have questions about this add-on? Our support team is here to help.
              </p>
