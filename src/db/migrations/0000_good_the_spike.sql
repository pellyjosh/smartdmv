...
ALTER TABLE "ai_configs" ADD CONSTRAINT "ai_configs_configured_by_users_id_fk" FOREIGN KEY ("configured_by") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;