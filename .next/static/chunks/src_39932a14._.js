(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_39932a14._.js", {
...
function AuthProvider({ children }) {
    ...
    const [isLoading, setIsLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true); // For initial load and subsequent auth operations
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            ...
            try {
                ...
                setClientCookie(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$authConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SESSION_TOKEN_COOKIE_NAME"], null, 0);
            }
    ...
    const login = async (emailInput, passwordInput)=>{
        ...
        try {
            ...
            setClientCookie(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$authConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SESSION_TOKEN_COOKIE_NAME"], userString, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$authConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SESSION_MAX_AGE_SECONDS"] / (24 * 60 * 60));
    ...
    const logout = async ()=>{
        ...
        try {
            ...
            setUser(null);
            sessionStorage.removeItem('smartdvm-user-session');
            setClientCookie(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$authConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SESSION_TOKEN_COOKIE_NAME"], null, 0); // Clear client-readable cookie
    ...
    const switchPractice = async (newPracticeId)=>{
        if (user && user.role === 'ADMINISTRATOR') {
            ...
            try {
                ...
                const { success, updatedUser: refreshedUser } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$actions$2f$authActions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["switchPracticeAction"])(user.id, newPracticeId);
...
//# sourceMappingURL=src_39932a14._.js.map